...
aboveRange =(msp(:) > ub(1)); msp(aboveRange)= round(msp(aboveRange)-(1.1*(msp(aboveRange)-ub(1))),0);
%belowRange = (t(:) < range(1)); t(belowRange)= t
belowRange =(msp(:) < lb(1)); msp(belowRange)=round(msp(belowRange)-(1.1*(msp(belowRange)-lb(1))),0);
end